...
// src/plugins/data/common/index_patterns/index_patterns/index_pattern.ts:57:45 - (ae-forgotten-export) The symbol "IndexPatternFieldMap" needs to be exported by the entry point index.d.ts
